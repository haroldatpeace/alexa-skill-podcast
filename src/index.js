...
const controller = {
  async play(handlerInput) {
    ...
    if(handlerInput.requestEnvelope
      ...
      && handlerInput.requestEnvelope.request.intent.slots.rhyme.resolutions
      && handlerInput.requestEnvelope.request.intent.slots.rhyme.resolutions.resolutionsPerAuthority[0]){
      rhyme = handlerInput.requestEnvelope.request.intent.slots.rhyme.resolutions.resolutionsPerAuthority[0].values[0].value.name;
    }
